...
import { createDemoState, createEmptyState } from "@/lib/defaults";
...
export function AppStateProvider({ children }) {
  const [state, setState] = useState(() => cloneState(createEmptyState()));
  ...
  const actions = useMemo(() => ({
    ...
    replaceState(nextState, user = null) {
      setState({
